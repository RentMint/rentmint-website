...
const FloatingRentalButton = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert("Thank you for your request! We'll connect you with suitable landlords soon.");
  };
  ...
  return (
    <Drawer>
      <DrawerTrigger asChild>
        <Button 
          size="lg"
          className="fixed bottom-6 right-6 z-50 bg-rentmint-primary hover:bg-rentmint-primary/90 text-white shadow-lg rounded-full px-6 py-3 flex items-center gap-2 transition-all duration-300 hover:scale-105"
        >
      ...
      <DrawerContent className="max-h-[90vh]">
        <DrawerHeader className="text-center">
          <DrawerTitle className="text-2xl font-display text-rentmint-primary">
